                    ...
                    <div class="navbar-search-block">
                        <form class="form-inline">
                            <div class="input-group input-group-sm">
                                <input required class="form-control form-control-navbar" type="search"
            ...
            <div class="sidebar">
                ...
                <div class="form-inline">
                    <div class="input-group" data-widget="sidebar-search">
                        <input required class="form-control form-control-sidebar" type="search" placeholder="Search"
                            aria-label="Search">
                        <div class="input-group-append">
                                ...
                                <div class="card-body">
                                    ...
                                    <table id="example3" class="table table-bordered table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $sql = "SELECT NOMR, nama_pasien, masuk_rs, ruangan, kelas_bpjs FROM simrs.t_clinicalpathway;";
                                            ...
                                            if (mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="detailkelas1.php?nomr=<?php echo $nomr ?>"
                                                                class="nav-link">
                                                                <button type="button"
                                                                    class="btn btn-block bg-gradient-primary btn-sm">Detail</button>
                                                            </a>
                                                        </td>
                                                    </tr>
                                                    <?php
                                                ...
                                                <form method="post" action="controller/insert_data.php">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <input required type="text" class="form-control" id="nomr"
                                                                name="nomr" placeholder="Masukan No. RM">
                                                        </div>
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select required class="custom-select form-control-border"
                                                                name="ruangan" id="exampleSelectBorder">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select required class="custom-select form-control-border"
                                                                name="kelas_bpjs" id="exampleSelectBorder">
