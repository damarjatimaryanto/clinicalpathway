                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div class="custom-control custom-radio">
                                                            <?php if ($biaya223 == 806) { ?>
                                                                <input class="custom-control-input" type="radio" id="customRadio63511" name="biaya223" value="806" onchange="hitungTotal37()" checked>
                                                                <label for="customRadio63511" class="custom-control-label">1X</label>
                                                            <?php } else { ?>
                                                                <input class="custom-control-input" type="radio" id="customRadio63511" name="biaya223" value="806" onchange="hitungTotal37()">
                                                                <label for="customRadio63511" class="custom-control-label">1X</label>
                                                            <?php
                                                            } ?>
                                                        </div>
                                                        ...
                                                        <div class="custom-control custom-radio">
                                                            <?php if ($biaya223 == 1612) { ?>
                                                                <input class="custom-control-input" type="radio" id="customRadio63512" name="biaya223" value="1612" onchange="hitungTotal37()" checked>
                                                                <label for="customRadio63512" class="custom-control-label">2X</label>
                                                            <?php } else { ?>
                                                                <input class="custom-control-input" type="radio" id="customRadio63512" name="biaya223" value="1612" onchange="hitungTotal37()">
                                                                <label for="customRadio63512" class="custom-control-label">2X</label>
                                                            <?php
                                                            } ?>
                                                        </div>
                                                        ...
                                                        <div class="custom-control custom-radio">
                                                            <?php if ($biaya223 == 2418) { ?>
                                                                <input class="custom-control-input" type="radio" id="customRadio63513" name="biaya223" value="2418" onchange="hitungTotal37()" checked>
                                                                <label for="customRadio63513" class="custom-control-label">3X</label>
                                                            <?php } else { ?>
                                                                <input class="custom-control-input" type="radio" id="customRadio63513" name="biaya223" value="2418" onchange="hitungTotal37()">
                                                                <label for="customRadio63513" class="custom-control-label">3X</label>
                                                            <?php
                                                            } ?>
                                                        </div>
